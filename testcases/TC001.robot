...
*** Test Cases ***
TC001 Delivery Flow with POD Cash
    ...
    delivery_order_feature.Deliver order normal
    ...
    Browser.Take Screenshot    filename=${OUTPUT_DIR}/screenshots/TC001_result.png    fullPage=True
